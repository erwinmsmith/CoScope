...
Export one shard:
    ...
    python -m scripts.export_trace_bundle \
        --input data/processed/cot/musique/dev/s1_linear.jsonl \
        --output-dir data/exports/musique_dev_traces

Export a whole split directory and also emit a combined markdown file:

    python -m scripts.export_trace_bundle \
        --input data/processed/cot/musique/dev \
        --output-dir data/exports/musique_dev_traces \
...
from scripts.render_trace import render_episode_markdown
