...
from config.settings import CoScopeConfig, get_config, ConfigLoader
from core.scope import PolicyConstraints, ScopeRegistry, ScopeSpec
...
if TYPE_CHECKING:
    from agents.langchain_agent import CoScopeRetrievalTool
...
class CoScope:
    ...
    def create_scope(
        ...
        **kwargs,
        ...
        from core.scope import ScopeDefinition, ScopeType
