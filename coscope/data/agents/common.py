...
def _workspace_scope_for_role(
    ...
    """v2.1: Solver gets hop-level workspace; Planner / Verifier get the global one."""
    if role == AgentRole.SOLVER and hop_index is not None:
        return workspace_semantic_hop(dataset, hop_index)
