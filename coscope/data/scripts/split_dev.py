...
Usage:
    python -m coscope.data.scripts.split_dev --dataset gsm8k --data-dir data/raw/gsm8k
    python -m coscope.data.scripts.split_dev --dataset math --data-dir data/raw/math
"""
