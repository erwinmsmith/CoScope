...
Usage:
    python -m coscope.data.scripts.smoke_test
"""
...
from coscope.data import build_episode            # noqa: E402
from coscope.data.core.types import GraphType     # noqa: E402
from coscope.data.output.serializer import Serializer  # noqa: E402
