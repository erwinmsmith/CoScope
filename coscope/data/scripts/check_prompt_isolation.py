...
Scans every `.py` file under `coscope/data/` and fails if any of them
...
Usage
-----
    python -m coscope.data.scripts.check_prompt_isolation            # default src dir
    python -m coscope.data.scripts.check_prompt_isolation --src other/path
