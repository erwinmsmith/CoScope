...
from coscope.data.core.types import Episode, GraphType, SubsetLabel
from coscope.data.loaders import get_loader
...
def _build_one(
    ...
    from coscope.data.output.serializer import Serializer as _Ser
    from coscope.data.pipeline.episode_builder import EpisodeBuilder as _Builder
