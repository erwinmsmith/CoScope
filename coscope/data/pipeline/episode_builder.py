...
from coscope.data.agents import (
    PlannerAgentBuilder,
    SolverAgentBuilder,
...
from coscope.data.split.subset_assigner import SubsetAssigner, load_default_thresholds
...
class EpisodeBuilder:
    ...
    def _build_ground_truth(
        ...
        for entry in memory_entries:
            ...
            if layer in ("workspace_semantic_global", "workspace_semantic_hop"):
                required_by = [a.agent_id for a in agents]
                evidence_type = "shared_required"
                hop_index = meta.get("hop_index") if layer == "workspace_semantic_hop" else None
