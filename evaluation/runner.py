...
from core.types import RetrievalRequest, RetrievalResult
from engine import CoScope
from evaluation.metrics import EvaluationReport, GoldMap, ResultPredicate
...
class VariantRun:
    ...
    def to_row(self) -> dict[str, Any]:
        ...
        return {
            ...
            "evidence_hit_rate": self.report.evidence_hit_rate,
            "first_stage_savings": self.report.first_stage_savings,
            "fallback_rate": self.report.fallback_rate,
    ...
    for run in runs:
        ...
        rows.append(
            [
                ...
                _fmt(row["evidence_hit_rate"], digits),
                _fmt(row["mrr_at_k"], digits),
                _fmt(row["first_stage_savings"], digits),
                _fmt(row["fallback_rate"], digits),
